...
async function loadDepartments() {
  ...
  optionsList.innerHTML =
    '<div class="loading-options"><i class="fa-solid fa-spinner fa-spin"></i> Loading departments...</div>';
  ...
  try {
    ...
    optionsList.innerHTML =
      '<div class="loading-options">Failed to load departments</div>';
  }
}
...
async function registerTeacher(event) {
  ...
  try {
    ...
    const response = await fetch(
      "https://attendance-tracker-tvx5.onrender.com/register",
      {
        method: "POST",
        headers: {
